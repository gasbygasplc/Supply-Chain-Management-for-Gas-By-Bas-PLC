...
import { fetchDeliveryShedule, gasRequest, getCity, getOutletId, getOutletLocation, outletLogin, sendGasRequestForDeliveryShedule } from '../controllers/OutletControllers.js';
...
outletRouter.get('/outletId' , getOutletId);
