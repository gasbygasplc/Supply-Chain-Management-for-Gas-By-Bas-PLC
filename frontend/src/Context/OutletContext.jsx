...
const OutletContextProvider = (props) => {
    ...
    const getOutletLocation = async() => {
        ...
        try 
        {
            ...
            const response = await axios.get('http://35.196.212.150:4000/api/outlet/location');
    ...
    const getCity = async(district) => {
        ...
        try 
        {
            ...
            const response = await axios.get(`http://35.196.212.150:4000/api/outlet/city/${district}`)
    ...
    const getOutletName = async(city) => {
        ...
        try 
        {
            ...
            const response = await axios.get(`http://35.196.212.150:4000/api/outlet/outletName/${city}`)
