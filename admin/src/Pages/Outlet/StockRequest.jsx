...
const StockRequest = () => {
  return (
    ...
    <div className='w-full md:w-[60%] text-gray-700 text-base mt-6 rounded-md py-1 px-6 mx-auto md:mx-[2%] bg-white border'>

      <h1 className='font-semibold py-2 text-2xl md:text-2xl mb-4'>Delivery Shedule Stock Request</h1>

      <div className='w-full flex flex-col gap-6'>

        <div className='flex flex-col md:grid grid-cols-6 md:gap-6'>

          <div className='w-full flex flex-col md:col-span-2 gap-2'>
