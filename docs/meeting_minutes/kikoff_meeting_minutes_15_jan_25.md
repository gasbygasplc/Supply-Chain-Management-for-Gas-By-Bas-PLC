...
**Date**: 15th January 2024 (Wednesday)  
**Time**: 8.30 PM  
**Mode**: Google Meet  
...
## **Agenda**
1. Deeply Disscuss about gas request frontend  
2. Discuss About error faced
3. Discuss About Everyone's plan
4. Disscuss about Development process  
5. Push Meeting Minutes to GitHub Repository  
...
### **1. Needs Corrections**
- **Requirements**:  
  -Diyath explain the gas request and functional of it.  
  ...
  - Need to add user category and organization category.
...
## **Next Steps**
1. Finalize the Gas request frontend by Mathumitha.  
2. Group Task distribution.
3. Harishanth Kandeepan & Mathumitha Srikanthan gonna make the Ui of the system
4. Create branches and start to backend code for gas request by Diyath.    
